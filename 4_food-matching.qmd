...
1.  Do you think that the food matches selected represents well what it is consumed in the survey?
...
When all the FCTs are standardised, we can use them all together, hence if a food item is missing in the main FCT, then a similar food item could be found in another FCT.
